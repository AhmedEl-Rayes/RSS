    ...
    <div id="about" className="py-16 bg-gradient-to-b from-cyber-darker to-cyber-dark">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center mb-12">
          <h2 className="text-base text-cyber-cyan font-semibold tracking-wide uppercase">About SentriSec</h2>
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="mt-2 text-gray-300">
                    SentriSec has been recognized for excellence in cybersecurity services by leading industry organizations and publications.
                  </p>
                </div>
              </div>
            </div>
